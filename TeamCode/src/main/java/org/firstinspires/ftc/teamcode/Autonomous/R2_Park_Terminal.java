...
@Autonomous(name="R2 Park Terminal", group="Red")
//@Disabled
public class R2_Park_Terminal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //strafing left several inches into substation (middle triangle)
        if (state == 1){
            telemetry.addData("State","1");
            telemetry.update();
            //encoderDrive(DRIVE_SPEED, 5, 5, 5, 5, 4.0);
            //Strafe left into red substation.
            strafeRight(DRIVE_SPEED, 27);
            state = 2;
        }
        //stopping robot
        if(state == 2){
