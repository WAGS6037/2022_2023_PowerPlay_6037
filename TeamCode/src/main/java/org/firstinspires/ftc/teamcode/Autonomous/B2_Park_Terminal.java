...
@Autonomous(name="B2 Park Terminal", group="Blue")
//@Disabled
public class B2_Park_Terminal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (state == 1){
            ...
            //Strafe left into blue substation.
            strafeLeft(DRIVE_SPEED, 27);
            state = 2;
        }
        //stopping robot
        if(state == 2){
