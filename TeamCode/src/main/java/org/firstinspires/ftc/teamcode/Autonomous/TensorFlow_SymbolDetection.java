 ...
 * is explained below.
 */
@Autonomous(name = "TensorFlow_SymbolDetection", group = "Autonomous")
//@Disabled
public class TensorFlow_SymbolDetection extends LinearOpMode {
    ...
    private static final String TFOD_MODEL_FILE = "/sdcard/FIRST/tflitemodels/best-fp16.tflite";
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            // if statement with identified values go here, i think.
                        }
                        telemetry.update();
                    }
                }
